            ...
            >
                ...
                >
                    <Box component='div' style={{ width: '80%' }}>
                        ...
                        <Button variant='contained' sx={{mr:'10px'}} onClick={() => navigate(-1)}>Go Back</Button>
                        <Button variant='contained' sx={{mr:'10px'}} onClick={() => navigate(`../productEdit/${id}`,{ replace: true })}>Edit Product</Button>
                        <Button variant='contained' sx={{mr:'10px'}} onClick={() => navigate(-1)}>Delete Product</Button>
                    </Box>
