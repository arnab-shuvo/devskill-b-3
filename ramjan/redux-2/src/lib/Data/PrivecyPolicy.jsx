import privecy from '../../assets/images/privecy.jpg';

const PrivecyPlicyData = {
    title: 'Privecy Policy',
    description : `We build a range of services that help millions of people daily to explore and interact with the world in new ways. Our services include:
